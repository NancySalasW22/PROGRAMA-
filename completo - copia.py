...
df = pd.read_csv('https://archive.ics.uci.edu/ml/'
                 'machine-learning-databases/diabetes/diabetes.data', header=None)
print(df.tail())

#############################################################################
print(50 * '=')
print('Fecha en formato MM-DD-YYYY')
print('Tiempo en formato XX:YY')
print('Codigo')
print('Valor')

print(50 * '-')

# seleccionamos fecha, tiempo, codigo y valor 
y = df.iloc[0:100, 4].values
y = np.where(y == 'fecha', -1, 1)
y = np.where(y == 'tiempo', -1, 1)
y = np.where(y == 'codigo', -1, 1)
y = np.where(y == 'valor', -1, 1)

# extract sepal length and petal length
X = df.iloc[0:100, [0, 2]].values

# plot data   --- CLASIFICA POR COLORES (TIEMPO Y VALOR)
plt.scatter(X[50:100, 0], X[50:100, 1],
            color='red', marker='x', label='tiempo')
plt.scatter(X[:50, 0], X[:50, 1],
            color='blue', marker='x', label='valor')

plt.ylabel('tiempo [XX:YY]')
plt.ylabel('valor ')
